...
## Please make sure you are assigned to an [Issue](https://github.com/pattarai/iam-single-sign-on-across-domains/issues) before submitting a pull request

Go to the [issue](https://github.com/pattarai/iam-single-sign-on-across-domains/issues) page and either
...
```
git remote add upstream https://github.com/pattarai/iam-single-sign-on-across-domains.git
